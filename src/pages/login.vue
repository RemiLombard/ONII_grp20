  ...
  <div class="bg-nightblue py-10 px-5 rounded-3xl">
    ...
    <form @submit.prevent="handleSignIn">
      ...
      <div class="justify-center mb-5">
        <RouterLink to="/forgot-password" class="text-gray-400 hover:underline"
          >Mot de passe oublié ?</RouterLink
        >
      </div>
      <div v-if="errorMessage" class="mb-5 text-red-400">
        {{ errorMessage }}
      </div>
      <div class="flex flex-col items-center justify-center gap-5">
        ...
        <p>
          ...
          <RouterLink to="/signup" class="text-yellow-200 hover:underline"
