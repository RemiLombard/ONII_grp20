...
<template>
  <header class="sticky top-0 z-50 w-full bg-slate-950 ">
    <div class="flex flex-col border-b border-white border-opacity-50">
                    ...
                    <section class="flex flex-col items-center justify-center gap-8">
                        ...
                        <div class="w-full">
                            <div class="bg-violet-950 rounded-[15px] p-2.5 w-full">
                                <div class="flex justify-start items-center box-content self-stretch flex-grow-0 flex-shrink-0 h-6 relative gap-2 border-b border-white border-opacity-50 pb-3.5">
                                    <IconGroupuser/>
                                    <p class="flex-grow w-64 text-base font-bold text-left text-white">Profil public</p>
                                    <IconTo/>
                                </div>
                                <div class="flex justify-start items-center box-content self-stretch flex-grow-0 flex-shrink-0 h-6 relative gap-2 border-b border-white border-opacity-50 py-3.5">
                                    <IconAccountSmall/>
                                    <p class="flex-grow w-64 text-base font-bold text-left text-white">Votre compte</p>
                                    <IconTo/>
                                </div>
                                <div class="flex justify-start items-center box-content self-stretch flex-grow-0 flex-shrink-0 h-6 relative gap-2 pt-3.5">
                                    <IconNewsletter/>
                                    <p class="flex-grow w-64 text-base font-bold text-left text-white">S'abonner à la Newslater</p>
                                    <IconTo/>
                                </div>
                            </div>
                            <div class="bg-violet-950 rounded-[15px] p-2.5 mt-8">
                                <RouterLink to="" class="flex justify-start items-center box-content self-stretch flex-grow-0 flex-shrink-0 h-6 relative gap-2 border-b border-white border-opacity-50 pb-3.5">
                                    <IconAbout/>
                                ...
                                <div class="flex justify-start items-center box-content self-stretch flex-grow-0 flex-shrink-0 h-6 relative gap-2 pt-3.5">
                                    <IconContact/>
                                    <p class="flex-grow w-64 text-base font-bold text-left text-white">Nous contacter</p>
                                    <IconTo/>
                                </div>
                            </div>
                        </div>
        ...
        <NavBar v-if="['/journal', '/reseau', '/journal/stats', '/reseau/test'].includes(route.path)"/>
    </div>
  </header>
</template>